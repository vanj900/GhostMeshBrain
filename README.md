...
## In Action — 10 000-tick run

The plots below are generated by `examples/analyze_run.py` from a real
10 000-tick simulation (`seed=42`, `compute_load=1.0`).

**Vital signs trajectory, affect signal, free-energy curve, action distribution, and personality-mask pie chart:**

![GhostMesh run analysis — vitals, affect, free energy, masks](docs/run_analysis_10k.png)

### 10 000-tick results summary
...
| **Avg stability** | 94.8 |
| **Avg affect** | −0.159 |
| **Avg free energy** | 21.88 |
| **Avg allostatic load** | 71.63 |
| **Max DECIDE streak** | 269 |
| **Preventive Maintenance Index** | 1.000 (fully anticipatory) |
...
> cp docs/run_analysis.png docs/run_analysis_10k.png
> ```
